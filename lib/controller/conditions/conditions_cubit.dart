...
class ConditionsCubit extends Cubit<AccountState> {
  ConditionsCubit() : super(AccountInitial());
  final _firestore = FirebaseFirestore.instance;

  Future<void> getConditionsData() async {
    emit(AccountLoading());
    ...
    try {
      ...
      if (currentUser == null) {
        ...
        await CacheData.setMapData(key: "conditionsData", value: demoUserData.toJson());
        emit(AccountSuccess(conditionsDataModel: demoUserData));
        return;
      }
      ...
      if (doc.exists && doc.data() != null) {
          ...
          await CacheData.setMapData(
            key: "conditionsData",
            value: conditionsDataModel.toJson(),
          );
          ...
          emit(AccountSuccess(conditionsDataModel: fallbackUserData));
        }
